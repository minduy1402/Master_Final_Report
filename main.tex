...
Từ phân tích trên, chúng tôi sử dụng Data-centric Fine-tuning để "đúc" (bake) toàn bộ các lớp hành vi này vào trọng số của mô hình nhỏ, biến nó thành một chuyên gia thực thụ trong lĩnh vực của mình. Chúng tôi đặt ra hai câu hỏi nghiên cứu chính:
